...
The database was created for the Cosmology department at the University of Arizona as a senior capstone project.
...
console_handler.setLevel(
    logging.WARNING
)  # logs all messages with level WARNING and above
...
'''update db_params to user's params'''
db_params = {
    "host": "localhost",
    "dbname": "data",
        ...
        for item_json in data:
            if "telpos" in item_json:
                ...
                insert_query = sql.SQL(
                    "INSERT INTO telpos (ts, prio, ec, epoch, ra, dec, el, ha, am, rotoff)\
                ...
                item = json.loads(item_json)  # Parse the JSON string into a dictionary
                insert_query = sql.SQL(
                    "INSERT INTO teldata (ts, prio, ec, roi, tracking, guiding, slewing, guiderMoving, az, zd, pa, domeAz, domeStat) \
                                       VALUES ({}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}) ON CONFLICT (ts) DO NOTHING;"
                ).format(
                    sql.Literal(item["ts"]),
                    sql.Literal(item["prio"]),
                ...
                item = json.loads(item_json)  # Parse the JSON string into a dictionary
                insert_query = sql.SQL(
                    "INSERT INTO telvane (ts, prio, ec, secz, encz, secx,    encx, secy, ency, sech, ench, secv, encv)\
                                       VALUES ({}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}) ON CONFLICT (ts) DO NOTHING;"
                ).format(
                    sql.Literal(item["ts"]),
                    sql.Literal(item["prio"]),
                ...
                item = json.loads(item_json)  # Parse the JSON string into a dictionary
                insert_query = sql.SQL(
                    "INSERT INTO telenv (ts, prio, ec, tempout, pressure,    humidity, wind, winddir, temptruss, tempcell, tempseccell, tempamb, dewpoint)\
                                       VALUES ({}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {},   {}) ON CONFLICT (ts) DO NOTHING;"
                ).format(
                    sql.Literal(item["ts"]),
                    sql.Literal(item["prio"]),
                ...
                item = json.loads(item_json)  # Parse the JSON string into a dictionary
                insert_query = sql.SQL(
                    "INSERT INTO telsee (ts, prio, ec, dimm_time, dimm_el,   dimm_fwhm, dimm_fwhm_corr, mag1_time, mag1_el, mag1_fwhm, mag1_fwhm_corr,     mag2_time, mag2_el, mag2_fwhm, mag2_fwhm_corr)\
                                        VALUES ({}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {},  {}, {}, {}, {}) ON CONFLICT (ts) DO NOTHING;"
                ).format(
                    sql.Literal(item["ts"]),
                    sql.Literal(item["prio"]),
                ...
                item = json.loads(item_json)  # Parse the JSON string into a dictionary
                insert_query = sql.SQL(
                    "INSERT INTO telcat (ts, prio, ec, catObj, catRm, catRa, catDec, catEP, catRO)\
                                        VALUES ({}, {}, {}, {}, {}, {}, {}, {}, {}) ON  CONFLICT (ts) DO NOTHING;"
                ).format(
                    sql.Literal(item["ts"]),
                    sql.Literal(item["prio"]),
        ...
        try:
            ...
            if option == 2:
                ...
                try:
                    ...
                    logger.info(f"Table {trun_table} truncated")
                except Exception as e:
                    logger.exception(e)
                    print(e)
